...
import static com.it.academy.library.util.ConstantUtil.ORDER_RETURN_DATE_2022_10_21_T_18_05;
    ...
    class CRUD {
        ...
        void saveOrder() {
            ...
            var order = Order.builder()
                    ...
                    .returnDate(ORDER_RETURN_DATE_2022_10_21_T_18_05)
                    .build();
        ...
        void updateOrder() {
            ...
            order.ifPresent(entity -> {
                ...
                entity.setReturnDate(ORDER_RETURN_DATE_2022_10_21_T_18_05);
            ...
            actual.ifPresent(entity ->
                    assertAll(
                            ...
                            () -> assertEquals(ORDER_RETURN_DATE_2022_10_21_T_18_05, entity.getReturnDate()),
